        ...
        <section className="border-b border-hairline bg-surface pt-40 pb-24">
          <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
            ...
            <p className="mt-7 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              From network design to decades of field maintenance, N3 Solutions delivers
              the systems public utilities rely on — and stands behind their performance.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
            ...
            <div className="mt-14 grid gap-10 md:grid-cols-3">
              {[
                ...
                <div key={s.step} className="border-t border-[color-mix(in_oklab,var(--color-surface)_20%,transparent)] pt-6">
                  <p className="text-sm font-semibold tracking-[0.2em] text-accent-teal">{s.step}</p>
          ...
          <div className="mx-auto flex max-w-[1240px] flex-col items-start gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-10">
            <div>
              ...
              <p className="mt-3 max-w-xl text-muted-foreground">
                Tell us about your infrastructure objectives and we will respond with a
