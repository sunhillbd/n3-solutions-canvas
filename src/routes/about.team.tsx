        ...
        {(() => {
          ...
          const renderSection = (key: string) => {
            switch (key) {
              ...
              case "executives":
                return toggles.show_executives !== false ? (
                  <section key="executives" className="border-y border-hairline bg-background py-28 lg:py-36">
              ...
              case "functional_leads":
                return toggles.show_functional_leads !== false ? (
                  <section key="functional_leads" className="bg-surface py-28 lg:py-36">
                    <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
                      <div className="max-w-3xl">
                    ...
                    <div className="mx-auto flex max-w-[1240px] flex-col items-start gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-10">
                      <div>
                        <h2 className="text-3xl font-semibold tracking-tight">
                          {content.cta_title || "Speak directly with our technical leadership."}
                        </h2>
                        <p className="mt-3 max-w-xl text-navy-foreground/75">
                          {content.cta_subtitle ||
                            "Schedule an engineering briefing on our technology stack, metrology compliance, and SLA structures."}
                        </p>
                      </div>
