            ...
            switch (key) {
              case "hero":
                return toggles.show_hero !== false ? (
                  <section key="hero" className="relative overflow-hidden bg-surface pt-44 pb-28 lg:pt-52 lg:pb-36">
              ...
              case "capabilities":
                return toggles.show_capabilities !== false ? (
                  <section key="capabilities" id="capabilities" className="bg-background py-28 lg:py-36">
              ...
              case "about_teaser":
                return toggles.show_about_teaser !== false ? (
                  <section key="about_teaser" id="about" className="relative overflow-hidden bg-navy text-navy-foreground">
              ...
              case "team_teaser":
                return toggles.show_team_teaser !== false ? (
                  <section key="team_teaser" id="team" className="border-b border-hairline bg-surface py-28 lg:py-36">
                    <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
              ...
              case "newsroom":
                return toggles.show_newsroom !== false ? (
                  <section key="newsroom" id="news" className="bg-background py-28 lg:py-36">
                    <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
                      ...
                      <div className="mt-16 grid gap-px border border-hairline bg-hairline md:grid-cols-3">
                        {news.map((item) => (
                          <article
                            key={item.title}
                            className="flex flex-col justify-between bg-surface p-9 transition-shadow duration-300 hover:shadow-xs"
                          >
                            <div>
                              <p className="font-mono text-xs font-semibold text-accent-teal">
                                {item.tag}
                              </p>
                              <h3 className="mt-4 text-lg font-semibold leading-snug tracking-[-0.01em] text-navy">
                                {item.title}
                              </h3>
              ...
              case "faqs":
                return toggles.show_faqs !== false ? (
                  <section key="faqs" id="faq" className="border-t border-hairline bg-surface py-28 lg:py-36">
                    <div className="mx-auto max-w-[960px] px-6 lg:px-10">
                      ...
                      <div className="mt-16 rounded border border-hairline bg-background p-6 sm:p-9 shadow-xs">
                        <Accordion type="single" collapsible className="w-full">
                          {((content.page_faqs && Array.isArray(content.page_faqs) && content.page_faqs.length > 0)
                            ? content.page_faqs
                            : faqs
              ...
              case "cta":
                return toggles.show_cta !== false ? (
                  <section key="cta" id="contact" className="bg-navy-deep text-navy-foreground">
