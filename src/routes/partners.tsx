  ...
  return (
    <div id="top" className="min-h-screen bg-background font-sans text-foreground antialiased">
      ...
      <main>
        ...
        {/* Featured Partner Logo Strip */}
        {toggles.show_featured_logo_strip !== false && (
        ...
        {toggles.show_ecosystem !== false && (
          <section id="ecosystem" className="bg-background py-28 lg:py-36">
            <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
              <div className="max-w-3xl">
        ...
        {/* 3. How We Partner */}
        {toggles.show_engagement_models !== false && (
          <section className="border-t border-hairline bg-surface-muted py-28 lg:py-36">
            <div className="mx-auto max-w-[1240px] px-6 lg:px-10">
              <div className="max-w-3xl">
        ...
        {toggles.show_cta !== false && (
          <section className="bg-navy-deep text-navy-foreground py-24 lg:py-28">
